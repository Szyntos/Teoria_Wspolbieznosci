    ...
    public static void printWaitingLoops(int bufferSize, int threadsNumber) throws IOException {
        ...
        for (int i = 0; i < threadsNumber; i++){
            if (producers[i] != null){
                ...
                writer.write("producerfourcondhaswaiters,"+bufferSize+","+threadsNumber+","+i+","+producers[i].made+"\n");
            }
        }
        System.out.println("==========================================");
        for (int i = 0; i < threadsNumber; i++){
            if (consumers[i] != null) {
                ...
                writer.write("consumerfourcondhaswaiters,"+bufferSize+","+threadsNumber+","+i+","+consumers[i].taken+"\n");
            }
        }
        System.out.println("**** **** **** ****  ****  **** **** **** ****");
